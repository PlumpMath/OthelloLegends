package se.noren.android.othello;

import se.noren.android.admob.GoogleAdMobHandler;
import se.noren.android.othello.gamestates.ChooseOpponentState;
import se.noren.android.othello.googleanalytics.AnalyticsAccount;
 ...
 * @author Johan
 */
public class OthelloMenuActivity extends Activity {
    ...
    private class ButtonListener implements OnClickListener {
		...
		public void onClick(View v) {
		    ...
		    SharedPreferences settings = getSharedPreferences(ChooseOpponentState.PREFS_NAME, 0);
